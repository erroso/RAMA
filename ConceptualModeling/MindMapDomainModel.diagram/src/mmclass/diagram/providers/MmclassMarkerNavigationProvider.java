...
import mmclass.diagram.part.MmclassDiagramEditorUtil;
 ...
 * @generated
 */
public class MmclassMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = MmclassDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			MmclassDiagramEditorUtil.selectElementsInDiagram(editor,
