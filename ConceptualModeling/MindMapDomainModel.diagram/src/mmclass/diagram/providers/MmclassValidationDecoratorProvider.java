 ...
 * @generated
 */
public class MmclassValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = MmclassDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof MmclassDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& MindMapModelEditPart.MODEL_ID.equals(MmclassVisualIDRegistry
						.getModelID(view));
	}
