 ...
 * @generated
 */
public class MmclassViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = MmclassVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = MmclassVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!MmclassElementTypes.isKnownElementType(elementType)
				...
				if (!MindMapModelEditPart.MODEL_ID
						.equals(MmclassVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return EnumEditPart.VISUAL_ID == visualID
				|| AssociationEntityEditPart.VISUAL_ID == visualID
				|| AttributeEditPart.VISUAL_ID == visualID
				|| RootNodeEditPart.VISUAL_ID == visualID
				|| ConstantEditPart.VISUAL_ID == visualID
				|| EntityEditPart.VISUAL_ID == visualID
				|| AssociationEntity2EditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = MmclassVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != MmclassVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = MmclassVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = MmclassVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case EnumEditPart.VISUAL_ID:
			return createEnum_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case AssociationEntityEditPart.VISUAL_ID:
			return createAssociationEntity_2002(domainElement, containerView,
					index, persisted, preferencesHint);
		case AttributeEditPart.VISUAL_ID:
			return createAttribute_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case RootNodeEditPart.VISUAL_ID:
			return createRootNode_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case ConstantEditPart.VISUAL_ID:
			return createConstant_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case EntityEditPart.VISUAL_ID:
			return createEntity_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case AssociationEntity2EditPart.VISUAL_ID:
			return createAssociationEntity_3001(domainElement, containerView,
					index, persisted, preferencesHint);
		case Entity2EditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (MmclassVisualIDRegistry.getVisualID(elementTypeHint)) {
	 ...
	 * @generated
	 */
	public Node createEnum_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MmclassVisualIDRegistry.getType(EnumEditPart.VISUAL_ID));
		...
		Node label5001 = createLabel(node,
				MmclassVisualIDRegistry.getType(EnumNodeTextEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createAssociationEntity_2002(EObject domainElement,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MmclassVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createAttribute_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MmclassVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createRootNode_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MmclassVisualIDRegistry
				.getType(RootNodeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createConstant_2006(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MmclassVisualIDRegistry
				.getType(ConstantEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createEntity_2007(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MmclassVisualIDRegistry.getType(EntityEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createAssociationEntity_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	...
	public Node createEntity_3002(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MmclassVisualIDRegistry.getType(Entity2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Edge createEdge_4001(EObject domainElement, View containerView,
		...
		edge.setType(MmclassVisualIDRegistry.getType(EdgeEditPart.VISUAL_ID));
