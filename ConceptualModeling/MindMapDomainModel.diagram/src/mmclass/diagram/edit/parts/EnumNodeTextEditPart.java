 ...
 * @generated
 */
public class EnumNodeTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EnumNodeTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MmclassParserProvider
					.getParser(
							MmclassElementTypes.Enum_2001,
							getParserElement(),
							MmclassVisualIDRegistry
									.getType(mmclass.diagram.edit.parts.EnumNodeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
