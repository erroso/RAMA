...
import mmclass.diagram.edit.commands.MmclassCreateShortcutDecorationsCommand;
import mmclass.diagram.edit.policies.MindMapModelCanonicalEditPolicy;
import mmclass.diagram.edit.policies.MindMapModelItemSemanticEditPolicy;
...
public class MindMapModelEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Mmclass"; //$NON-NLS-1$
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new MmclassCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
