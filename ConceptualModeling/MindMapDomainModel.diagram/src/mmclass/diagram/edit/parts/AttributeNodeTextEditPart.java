 ...
 * @generated
 */
public class AttributeNodeTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AttributeNodeTextEditPart(View view) {
		super(view);
	}
			...
			parser = MmclassParserProvider
					.getParser(
							...
							MmclassVisualIDRegistry
									.getType(mmclass.diagram.edit.parts.AttributeNodeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
