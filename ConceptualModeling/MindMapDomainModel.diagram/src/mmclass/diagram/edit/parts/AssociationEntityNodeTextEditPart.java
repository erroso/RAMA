 ...
 * @generated
 */
public class AssociationEntityNodeTextEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AssociationEntityNodeTextEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return MmclassElementTypes.getImage(parserElement.eClass());
	}
			...
			parser = MmclassParserProvider
					.getParser(
							...
							MmclassVisualIDRegistry
									.getType(mmclass.diagram.edit.parts.AssociationEntityNodeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
