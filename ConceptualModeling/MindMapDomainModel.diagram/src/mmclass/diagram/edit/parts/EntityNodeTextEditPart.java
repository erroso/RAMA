 ...
 * @generated
 */
public class EntityNodeTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EntityNodeTextEditPart(View view) {
		super(view);
	}
			...
			parser = MmclassParserProvider
					.getParser(
							...
							MmclassVisualIDRegistry
									.getType(mmclass.diagram.edit.parts.EntityNodeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
