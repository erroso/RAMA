 ...
 * @generated
 */
public class EntityNodeText2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EntityNodeText2EditPart(View view) {
		super(view);
	}
			...
			parser = MmclassParserProvider
					.getParser(
							...
							MmclassVisualIDRegistry
									.getType(mmclass.diagram.edit.parts.EntityNodeText2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void refreshLabel() {
		...
		Entity node = (Entity) getNotationView().getElement();
