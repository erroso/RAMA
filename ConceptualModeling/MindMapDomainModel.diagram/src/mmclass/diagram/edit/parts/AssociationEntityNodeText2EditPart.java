 ...
 * @generated
 */
public class AssociationEntityNodeText2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AssociationEntityNodeText2EditPart(View view) {
		super(view);
	}
			...
			parser = MmclassParserProvider
					.getParser(
							...
							MmclassVisualIDRegistry
									.getType(mmclass.diagram.edit.parts.AssociationEntityNodeText2EditPart.VISUAL_ID));
		}
		return parser;
	}
