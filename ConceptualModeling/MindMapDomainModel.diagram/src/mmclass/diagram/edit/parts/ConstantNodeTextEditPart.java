 ...
 * @generated
 */
public class ConstantNodeTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ConstantNodeTextEditPart(View view) {
		super(view);
	}
			...
			parser = MmclassParserProvider
					.getParser(
							...
							MmclassVisualIDRegistry
									.getType(mmclass.diagram.edit.parts.ConstantNodeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
