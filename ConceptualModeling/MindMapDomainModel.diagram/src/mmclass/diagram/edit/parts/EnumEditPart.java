...
import mmclass.diagram.edit.parts.custom.EnumSourceFixedConnectionAnchor;
import mmclass.diagram.edit.parts.custom.HighlightingWrappingLabel;
import mmclass.diagram.edit.policies.EnumItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EnumEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EnumItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EnumFigure();
	}

	/**
	 * @generated
	 */
	public EnumFigure getPrimaryShape() {
		return (EnumFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EnumNodeTextEditPart) {
			((EnumNodeTextEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEnumLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof mmclass.diagram.edit.parts.EnumEditPart) {
			types.add(MmclassElementTypes.Edge_4001);
		}
	...
	public ConnectionAnchor getSourceConnectionAnchor(
		...
		if (sourceAnchor == null) {
			sourceAnchor = new EnumSourceFixedConnectionAnchor(
					getNodeFigure());
		}
		return sourceAnchor;
	}
	 ...
	 * @generated
	 */
	public class EnumFigure extends RoundedRectangle {

		/**
		 * @generated NOT
		 */
		private HighlightingWrappingLabel fFigureEnumLabelFigure;
		...
		private void createContents() {
			...
			fFigureEnumLabelFigure = new HighlightingWrappingLabel();

//			fFigureEnumLabelFigure.setText("Enum");

			this.add(fFigureEnumLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEnumLabelFigure() {
			return fFigureEnumLabelFigure;
		}
