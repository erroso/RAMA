...
import mmclass.diagram.edit.policies.MmclassTextSelectionEditPolicy;
 ...
 * @generated
 */
public class RootNodeNodeTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RootNodeNodeTextEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MmclassTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new MindMapModelEditPart.NodeLabelDragPolicy());
	}
	...
	protected void setLabelIconHelper(IFigure figure, Image icon) {
		if (figure instanceof WrappingLabel) {
			...
			((WrappingLabel) figure).setTextPlacement(PositionConstants.SOUTH);
			return;
		} else if (figure instanceof Label) {
			((Label) figure).setIcon(icon);
			((Label) figure).setTextPlacement(PositionConstants.SOUTH);
			return;
		} else {
			getLabelDelegate().setIcon(icon, 0);
			getLabelDelegate().setTextPlacement(PositionConstants.SOUTH);
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MmclassParserProvider
					.getParser(
							MmclassElementTypes.RootNode_2004,
							getParserElement(),
							MmclassVisualIDRegistry
									.getType(mmclass.diagram.edit.parts.RootNodeNodeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					MmclassEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected void refreshLabel() {
		...
		RootNode node = (RootNode) getNotationView().getElement();
		Object custom_icon = null;
		Object default_icon = MmclassEditPlugin.INSTANCE.getImage("/full/obj16"
				+ "/" + "RootNode" + ".gif");
		try {
			if (node.getCustomIcon() != null && !node.getCustomIcon().isEmpty()) {
				custom_icon = MmclassEditPlugin.INSTANCE.getImage("/full/obj16"
						+ "/" + node.getCustomIcon().toLowerCase() + ".gif");
			}
		} catch (java.util.MissingResourceException e) {

		}
		Image icon = ExtendedImageRegistry.INSTANCE.getImageDescriptor(
				default_icon).createImage();
		if (custom_icon != null) {
			icon = ExtendedImageRegistry.INSTANCE.getImageDescriptor(
					custom_icon).createImage();
		}
		setLabelIconHelper(getFigure(), icon);
