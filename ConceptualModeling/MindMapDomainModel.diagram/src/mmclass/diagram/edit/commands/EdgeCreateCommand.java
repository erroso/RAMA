...
public class EdgeCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		//----------
		if (source instanceof Entity && (target instanceof RootNode || target instanceof Enum || target instanceof Constant)) {
			return false;
		}
		if (source instanceof Attribute) {
			return false;
		}
		if (source instanceof Enum && (!(target instanceof Constant))) {
			return false;
		}
		//----------
		if (getSource() == null) {
		...
		return MmclassBaseItemSemanticEditPolicy.getLinkConstraints()
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,IAdaptable info) throws ExecutionException {
		...
		Edge newElement = MmclassFactory.eINSTANCE.createEdge();
		...
		if ((getSource() instanceof Entity)) {
			...
			if (getTarget() instanceof Attribute) {
				e.getAttributes().add((Attribute) getTarget());
			} else if (getTarget() instanceof Entity) {
				e.getEntities().add((Entity) getTarget());
			}
		} //here? 0o
