 ...
 * @generated
 */
public class MmclassElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public MmclassElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.MmclassElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "mdm".equals(fileExtension); //$NON-NLS-1$
	}
