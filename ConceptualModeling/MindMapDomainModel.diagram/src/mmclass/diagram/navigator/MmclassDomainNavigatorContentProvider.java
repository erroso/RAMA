 ...
 * @generated
 */
public class MmclassDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public MmclassDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof MmclassDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((MmclassDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new MmclassDomainNavigatorItem((EObject) objects[i],
