 ...
 * <ul>
 *   <li>{@link mindMapDomainModel.AssociationEntity#getAssociations <em>Associations</em>}</li>
 * </ul>
 * </p>
 *
 * @see mindMapDomainModel.MindMapDomainModelPackage#getAssociationEntity()
...
public interface AssociationEntity extends Entity
{
   ...
   * @see mindMapDomainModel.MindMapDomainModelPackage#getAssociationEntity_Associations()
