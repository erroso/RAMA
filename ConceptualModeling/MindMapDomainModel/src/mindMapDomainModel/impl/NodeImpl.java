 ...
 * <ul>
 *   <li>{@link mindMapDomainModel.impl.NodeImpl#getNodeText <em>Node Text</em>}</li>
 *   <li>{@link mindMapDomainModel.impl.NodeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link mindMapDomainModel.impl.NodeImpl#getCustomIcon <em>Custom Icon</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeImpl extends EObjectImpl implements Node
{
  ...
  {
    return MindMapDomainModelPackage.Literals.NODE;
  }
  ...
  public void setNodeText(String newNodeText)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MindMapDomainModelPackage.NODE__NODE_TEXT, oldNodeText, nodeText));
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MindMapDomainModelPackage.NODE__DESCRIPTION, oldDescription, description));
  }
  ...
  public void setCustomIcon(String newCustomIcon)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MindMapDomainModelPackage.NODE__CUSTOM_ICON, oldCustomIcon, customIcon));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MindMapDomainModelPackage.NODE__NODE_TEXT:
        return getNodeText();
      case MindMapDomainModelPackage.NODE__DESCRIPTION:
        return getDescription();
      case MindMapDomainModelPackage.NODE__CUSTOM_ICON:
