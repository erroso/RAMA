 ...
 * @generated
 */
public class MindMapDomainModelPackageImpl extends EPackageImpl implements MindMapDomainModelPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see mindMapDomainModel.MindMapDomainModelPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MindMapDomainModelPackageImpl()
  {
    super(eNS_URI, MindMapDomainModelFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link MindMapDomainModelPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MindMapDomainModelPackage init()
  {
    if (isInited) return (MindMapDomainModelPackage)EPackage.Registry.INSTANCE.getEPackage(MindMapDomainModelPackage.eNS_URI);

    // Obtain or create and register package
    MindMapDomainModelPackageImpl theMindMapDomainModelPackage = (MindMapDomainModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MindMapDomainModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MindMapDomainModelPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theMindMapDomainModelPackage.createPackageContents();

    // Initialize created meta-data
    theMindMapDomainModelPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMindMapDomainModelPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MindMapDomainModelPackage.eNS_URI, theMindMapDomainModelPackage);
    return theMindMapDomainModelPackage;
  }
   ...
   * @generated
   */
  public MindMapDomainModelFactory getMindMapDomainModelFactory()
  {
    return (MindMapDomainModelFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(enumEClass, mindMapDomainModel.Enum.class, "Enum", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getEnum_Constants(), this.getConstant(), null, "constants", null, 0, -1, mindMapDomainModel.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
