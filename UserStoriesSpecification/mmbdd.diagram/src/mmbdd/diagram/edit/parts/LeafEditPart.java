...
import mmbdd.diagram.edit.policies.LeafItemSemanticEditPolicy;
...
public class LeafEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LeafNodeTextEditPart) {
			((LeafNodeTextEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MmbddVisualIDRegistry
				.getType(LeafNodeTextEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof mmbdd.diagram.edit.parts.LeafEditPart) {
			types.add(MmbddElementTypes.Edge_4001);
		}
		return types;
	}
	 ...
	 * @generated
	 */
	public class LeafFigure extends RectangleFigure {
