 ...
 * @generated
 */
public class CenterNodeTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CenterNodeTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MmbddParserProvider
					.getParser(
							MmbddElementTypes.Center_2004,
							getParserElement(),
							MmbddVisualIDRegistry
									.getType(mmbdd.diagram.edit.parts.CenterNodeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
