...
import mmbdd.diagram.edit.policies.MmbddTextSelectionEditPolicy;
 ...
 * @generated
 */
public class RelationshipNodeTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RelationshipNodeTextEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MmbddTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return MmbddElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MmbddParserProvider
					.getParser(
							MmbddElementTypes.Relationship_2002,
							getParserElement(),
							MmbddVisualIDRegistry
									.getType(mmbdd.diagram.edit.parts.RelationshipNodeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					MmbddEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
			...
			EAttribute e_att = (EAttribute) event.getFeature();
			if (e_att.getName().equalsIgnoreCase("type")) {
				Image icon = ExtendedImageRegistry.INSTANCE.getImageDescriptor(
						MmbddEditPlugin.INSTANCE.getImage("/full/obj16" + "/"
								+ event.getNewStringValue().toLowerCase()
								+ ".gif")).createImage();
				setLabelIconHelper(getFigure(), icon);
			}
			if (getParser() != null
