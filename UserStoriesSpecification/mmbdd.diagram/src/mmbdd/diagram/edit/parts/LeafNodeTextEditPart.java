 ...
 * @generated
 */
public class LeafNodeTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LeafNodeTextEditPart(View view) {
		super(view);
	}
			...
			parser = MmbddParserProvider
					.getParser(
							...
							MmbddVisualIDRegistry
									.getType(mmbdd.diagram.edit.parts.LeafNodeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
