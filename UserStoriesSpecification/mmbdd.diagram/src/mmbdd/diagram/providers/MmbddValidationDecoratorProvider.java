 ...
 * @generated
 */
public class MmbddValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = MmbddDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof MmbddDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& MindMapModelEditPart.MODEL_ID.equals(MmbddVisualIDRegistry
						.getModelID(view));
	}
