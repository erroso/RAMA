...
import mmbdd.diagram.part.MmbddDiagramEditorUtil;
 ...
 * @generated
 */
public class MmbddMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = MmbddDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			MmbddDiagramEditorUtil.selectElementsInDiagram(editor,
