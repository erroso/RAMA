 ...
 * @generated
 */
public class MmbddElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public MmbddElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.MmbddElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "mmbdd".equals(fileExtension); //$NON-NLS-1$
	}
