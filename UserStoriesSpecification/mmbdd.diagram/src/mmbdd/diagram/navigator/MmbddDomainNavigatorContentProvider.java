 ...
 * @generated
 */
public class MmbddDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public MmbddDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof MmbddDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((MmbddDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new MmbddDomainNavigatorItem((EObject) objects[i],
