...
/**
 * This is the item provider adapter for a {@link mmbdd.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         MmbddPackage.Literals.RELATIONSHIP__TYPE,
         true,
         false,
         false,
  ...
  {
    String label = ((Relationship)object).getNodeText();
