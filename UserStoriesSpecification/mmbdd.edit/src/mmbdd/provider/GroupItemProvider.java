...
/**
 * This is the item provider adapter for a {@link mmbdd.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Group_nodes_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Group_nodes_feature", "_UI_Group_type"),
         MmbddPackage.Literals.GROUP__NODES,
         true,
         false,
         true,
         null,
  ...
  {
    String label = ((Group)object).getNodeText();
